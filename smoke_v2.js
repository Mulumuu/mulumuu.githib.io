...
// Стили для canvas (размещаем на весь экран как фон)
canvas.style.position = 'fixed';
canvas.style.top = '0';
canvas.style.left = '0';
canvas.style.width = '100%';
canvas.style.height = '100%';
canvas.style.zIndex = '-1'; // Помещаем за все элементы
canvas.style.pointerEvents = 'none'; // Чтобы не мешал взаимодействию с другими элементами
